 ...
 render() {
       return (
         <div id="jobdropdown" style={{marginLeft:'5%',color:'black',marginTop:'3%'}}>
            ...
            <p><a href="/deletejobjenkin">Click here </a>to download sample template<p> of delete a job.</p></p>
           <div style={{'marginLeft': '10%', 'marginTop': '5%'}}>
               <Form method='post' encType='multipart/form-data' >
                 <Input type='file' name='uploadedFile' accept='.yml'  onChange={this.changeFile.bind(this)}/>
                </Form>
                  <Button color = 'red' type = 'submit'  onClick={this.importFile.bind(this)} disabled={this.state.checkfile}><Icon name='upload'/>Submit</Button>
           </div>
            </div>
       );
   }
